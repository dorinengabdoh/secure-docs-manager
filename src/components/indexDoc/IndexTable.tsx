...
import { Eye, Filter, Search, ShieldCheck, ShieldX } from "lucide-react";
import { Archive, FilterType, SortBy, SortOrder } from "../../types";
import { translations } from "../../translations";
import { useLanguageStore } from "../../store/languageStore";
import { useArchiveStore } from "../../store/useArchiveStore";
import api from "../../utilities/api"; // make sure this is your axios instance
...
export const IndexTable: React.FC<IndexTableProps> = ({ isDark, onView }) => {
  ...
  return (
    ...
    >
      ...
      ) : filteredArchives.filter((archive) => archive.status === "draft")
          .length === 0 ? (
        <div className="text-center py-10 text-gray-500">
                  ...
                  >
                    ...
                    <td className="py-4 px-4 text-right">
                      <div className="flex justify-end space-x-2">
                        ...
                        {/* Approve button */}
                        <button
                          onClick={() => updateStatus(archive.id, "approved")}
                        ...
                        {/* Reject button */}
                        <button
                          onClick={() => updateStatus(archive.id, "rejected")}
